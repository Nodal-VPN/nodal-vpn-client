package com.logonbox.vpn.client.common.logging;
...
public class SimpleLogger extends LegacyAbstractLogger {
     ...
     * prefix
     */
    public static final String SYSTEM_PREFIX = "lbvpn.";
    ...
    public static final String THREAD_NAME_WIDTH_KEY = SimpleLogger.SYSTEM_PREFIX + "threadNameWidth";

    public static final String LOG_NAME_WIDTH_KEY = SimpleLogger.SYSTEM_PREFIX + "logNameWidth";
    ...
    private void innerHandleNormalizedLoggingCall(Level level, List<Marker> markers, String messagePattern, Object[] arguments, Throwable t) {
        ...
        if (CONFIG_PARAMS.showThreadName) {
            buf.append('[');            
            buf.append(padOrTrim(CONFIG_PARAMS.threadNameWidth, Thread.currentThread().getName()));
            buf.append("] ");
        }
        ...
        if (CONFIG_PARAMS.showShortLogName) {
            ...
            buf.append(padOrTrim(CONFIG_PARAMS.threadNameWidth, String.valueOf(shortLogName))).append(" - ");
        } else if (CONFIG_PARAMS.showLogName) {
            buf.append(padOrTrim(CONFIG_PARAMS.threadNameWidth, String.valueOf(name))).append(" - ");
        }
    ...
    String padOrTrim(int width, String str) {
        if(width == 0)
            return str;
        else {
            if(str.length() < width)
