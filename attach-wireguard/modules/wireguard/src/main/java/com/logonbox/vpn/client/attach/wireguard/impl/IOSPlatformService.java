...
/**
 * IOS implementation of a {@link PlatformService}, responsible for querying
 * the state of existing VPN connections, creating new ones and other platform
 * specific actions.
 */
public class IOSPlatformService extends AbstractPlatformService<AndroidIP> {

    /**
     * Constructor
     */
	protected IOSPlatformService() {
		super("wg");
	}
