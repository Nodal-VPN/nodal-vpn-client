                    ...
                    steps {
                        configFileProvider([
                            ...
                            withMaven(
                                ...
                                sh 'mvn -U -Dbuild.mediaTypes=unixInstaller,unixArchive,linuxRPM,linuxDeb -Dbuild.projectProperties=$BUILD_PROPERTIES -P installers,cross-platform -pl installer clean package'
