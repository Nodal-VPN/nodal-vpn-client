						...
						configFileProvider([
					 		...
					 		withMaven(
					 			globalMavenSettingsConfig: '4bc608a8-6e52-4765-bd72-4763f45bfbde'
					 		  	...
					 		  	bat 'mvn -Dbuild.mediaTypes=windows,windowsArchive "-Dbuild.projectProperties=%BUILD_PROPERTIES%" -P build-install4j-logonbox-vpn-client -pl client-logonbox-vpn-installer clean package'
			...
			steps {
    			...
    			/* Upload all installers and updates.xml for this build number */
		 		s3Upload(
		 			...
		 			entries: [[
		 				bucket: 'logonbox-packages/logonbox-vpn-client/EXPERIMENTAL/' + env.FULL_VERSION, 
